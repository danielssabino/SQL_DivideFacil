...
--
-- Servidor: localhost
-- Tempo de Geração: 15/10/2016 às 01:48:26
...
CREATE TABLE IF NOT EXISTS `tb_transacoes` (
  ...
  `transacao_tipo` varchar(1) COLLATE utf8_unicode_ci NOT NULL COMMENT '[D]ebito / [C]redito',
...
CREATE TABLE IF NOT EXISTS `tb_transacoes_detalhe` (
  ...
  `transacao_id` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `integrante_id` int(11) NOT NULL,
  `transacao_detalhe_valor` double(12,2) NOT NULL,
  `transacao_detalhe_divisao` double(16,6) NOT NULL,
  `transacao_detalhe_rateio` double(16,6) NOT NULL,
